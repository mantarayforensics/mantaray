...
def get_block_size_mmls (Image_Path, outfile, temp_time):
    block_size = subprocess.check_output (
        ['mmls -i raw ' + Image_Path + " | grep Units | awk '{print $4}' | sed s/-byte//"], shell=True,
...
def get_block_size_parted (outfile, temp_time):
    block_size_command = "sudo cat /tmp/timeline_partition_info_" + temp_time + ".txt | grep -a " + "'" + "Sector " \
                                                                                                          "size" + \
                         "'" + " | awk {'print $4'} | sed s_B/.*__"
    ...
    for line in fls_output_file:
        ...
        if (item == "NO"):  #process non-shadow volume files
            ...
            if (re.search ('OrphanFiles', line)):
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_ORPHAN_FILE" + "'"
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_DELETED_" + user_name + "_USRCLASS.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_OVERT_" + user_name + "_USRCLASS.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            ...
            if (re.search ('OrphanFiles', line)):
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_ORPHAN_FILE" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (10))
            elif (re.search ('\*', line)):
                #copy files out using icat
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_" + "DELETED_" + user_name + "_USRCLASS.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_" + "OVERT_" + user_name + "_USRCLASS.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
        ...
        if (item == "NO"):
            if (re.search ('OrphanFiles', line)):
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_DELETED_" + user_name + "_NTUSER.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_OVERT_" + user_name + "_NTUSER.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            ...
            if (re.search ('OrphanFiles', line)):
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "ORPHAN" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (10))
            elif (re.search ('\*', line)):
                #copy files out using icat
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_" + "_DELETED_" + user_name + "_NTUSER.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_" + "OVERT_" + user_name + "_NTUSER.DAT" + "'"
                print ("File Name: " + file_name.ljust (10) + "\t" "Inode number: " + inode_number.ljust (
                    10) + "\t UserName: " + user_name.ljust (10))
        ...
        if (item == "NO"):
            if (re.search ('OrphanFiles', line)):
                ...
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_DELETED_" + file_name + "'"
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_OVERT_" + file_name + "'"
        else:  #these are the shadow volume files
            if (re.search ('OrphanFiles', line)):
                #copy files out using icat
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_ORPHAN_FILE_" + "'"
            elif (re.search ('\*', line)):
                #copy files out using icat
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_DELETED_" + file_name + "'"
            else:
                #get user profile name
                icat_command = "icat -r -i raw -f " + value + " -o " + str (
                    key_bytes) + " -b " + block_size + " " + Image_Path + " " + inode_number + " > " + "'" + \
                               folder_path + "/" + inode_number + "_Partition_" + str (
                    key) + "_SHADOW_VOLUME_" + item + "_OVERT_" + file_name + "'"
...
def process_overt_deleted_files (value, key, Image_Path, outfile, folder_path, block_size, item, file_loc, temp_time):
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'ntuser.dat$\|_Registry_USER_NTUSER\|ntuser.bak$\|ntuser.sav$\|ntuser.old$' " \
                                        "| grep -v -i log | sed s/:// > /tmp/fls_output_" + temp_time + ".txt"
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'system$\|system.sav$\|system.dat$\|system.old$\|system.bak$" \
                                        "\|_Registry_Machine_SYSTEM$' | grep -v -i " \
                                        "'log\|FontCache-System.dat\|AnalyzeSystem' | sed s/:// > /tmp/fls_output_" +\
                  temp_time + ".txt"
    #print ("\nThe fls command is: " + fls_command + "\n")
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'software$\|software.sav$\|software.dat$\|software.old$\|software.bak$" \
                                        "\|_Registry_Machine_SOFTWARE$' | grep -v -i log | sed s/:// > " \
                                        "/tmp/fls_output_" + temp_time + ".txt"
    #print ("\nThe fls command is: " + fls_command + "\n")
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'security$\|security.sav$\|security.dat$\|security.old$\|security.bak$" \
                                        "\|_Registry_Machine_SECURITY$' | grep -v -i log | sed s/:// > " \
                                        "/tmp/fls_output_" + temp_time + ".txt"
    #print ("\nThe fls command is: " + fls_command + "\n")
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'sam$\|sam.sav$\|sam.dat$\|sam.old$\|sam.bak$\|_Registry_Machine_SAM$' | " \
                                        "grep -v -i 'log\|\.sam' | sed s/:// > /tmp/fls_output_" + temp_time + ".txt"
    #print ("\nThe fls command is: " + fls_command + "\n")
    ...
    fls_command = "fls -Fpr -f ntfs -i raw -o " + str (
        key_bytes) + " " + Image_Path + " | grep -i " \
                                        "'usrclass.dat$\|_Registry_USER_USRCLASS\|usrclass.bak\|usrclass.sav" \
                                        "\|usrclass.old' | grep -v -i log | sed s/:// > /tmp/fls_output_" + temp_time\
                  + ".txt"
    #print ("\nThe fls command is: " + fls_command + "\n")
...
def process_unallocated_clusters (value, key, Image_Path, outfile, case_number, folder_path, block_size):
    ...
    foremost_command = "foremost -q -d -o " + "'" + folder_path + "/Partition_" + str (
        key) + "/unallocated_files" + "'" + " -c /usr/share/Manta_Ray/Tools/conf_files/foremost.conf"
    ...
    for root, dirs, files in os.walk (folder_path):
        for file_name in files:
            if not (re.search (".txt", file_name)):
                ...
                try:
                    regfinfo_return = subprocess.check_output (
                        ["regfinfo " + "'" + abs_file_path + "'" + " | grep -q -m 1 Key"], shell=True,
...
def reset_registry_hive_timestamps (folder_path, outfile):
    ...
    for root, dirs, files in os.walk (folder_path):
        for file_name in files:
            ...
            abs_file_path = os.path.join (root, file_name)
            if re.search ("Partition", file_name) and (
                os.path.getsize (abs_file_path) and not (re.search (".txt", file_name))):
                #big_edian_command
                big_endian_command = "hexdump -v -s 12 -n 8 -e " + "'" + "1/1 " + '"' + " %02X" + '"' + "'" + " " + \
                                     "'" + abs_file_path + "'" + " | awk '{print $8$7$6$5$4$3$2$1}'"
                ...
                if (str (windows_dt).strip () != "1601-01-01 00:00:00"):
                    ...
                    outfile.write (
                        "About to move file with no last accessed time: " + abs_file_path + " to: " + destination)
                    os.rename (abs_file_path, destination)
...
def get_hive_type (folder_path, outfile, temp_time, key):
    ...
    for file_name in os.listdir (folder_path):
        ...
        if re.search (str (key) + "_Unallocated", file_name) and (
            os.path.getsize (abs_file_path) and not (re.search (".txt", file_name))):
        ...
        elif re.search (str (key) + "_ORPHAN", file_name) and (
            os.path.getsize (abs_file_path) and not (re.search (".txt", file_name))):
            #copy file to temp folder
            print ("Copying file: " + abs_file_path + " to /tmp/hives_to_rename_" + temp_time)
            #outfile("Copying file: " + abs_file_path + " to /tmp/hives_to_rename_" + str(temp_time) +"\n")
...
def get_hive_type_and_username (temp_time, file_name, outfile, abs_file_path, folder_path):
    try:
        header_info = subprocess.check_output ([
                                                   "head -c 150 " + "'" + "/tmp/hives_to_rename_" + temp_time + "/" +
                                                   file_name + "'" + " | iconv -c -f UTF-16 -t UTF-8"],
        ...
        if (re.search ("usrclass", header_info_decoded.lower ())):
            ...
            if (usrclass_name):
                ...
                outfile.write (
                    file_name + ": is USRCLASS.  USRCLASS name is: " + usrclass_name_decode + " -- renaming\n")
        ...
        elif (re.search ("system", header_info_decoded.lower ())) and not (
        re.search ("system32", header_info_decoded.lower ())):
...
def mount_shadow_volumes (vssvolume_mnt, outfile, folder_path, temp_time):
    ...
    for item in vss_volumes:
        ...
        for key, value in partition_info_dict.items ():
            ...
            process_overt_deleted_files (value, key, vssvolume_mnt + "/" + item, outfile, folder_path, block_size, item,
    ...
    for key, value in partition_info_dict.items ():
        ...
        if (value == "ntfs") or (value == "fat32"):
            ...
            if (re.search ("Overt", options)):
                process_overt_deleted_files (value, key, Image_Path, outfile, folder_path, block_size, item,
