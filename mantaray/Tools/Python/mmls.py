    ...
    for line in infile:
        if(re.search(":0\d", line)):
            ...
            if(re.search("0x27", line)) or (re.search("0x07", line)) or (re.search("0x12", line)):
                ...
                #push sector information and fs onto dictionary
                partition_info_dict[partition_start] = partition_filesystem
            elif(re.search("DOS FAT 16", line)) or (re.search("0x0E", line)) or (re.search("0x1E", line)) or (re.search("0x90", line)) or (re.search("0x92", line)) or (re.search("0x9a", line)) or (re.search("0x06", line)):
                partition_filesystem = "fat16"
                print("The filesystem is: " + partition_filesystem)
                #push sector information and fs onto dictionary
                partition_info_dict[partition_start] = partition_filesystem
            elif(re.search("Win95 FAT32", line)) or (re.search("0x8b", line)) or (re.search("0x8c", line)) or (re.search("0x97", line)) or (re.search("0x98", line)) or (re.search("0xcb", line)) or (re.search("0xcc", line)) or (re.search("0xdd", line)):
