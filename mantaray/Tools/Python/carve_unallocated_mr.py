    ...
    if (item_to_process == "Single File"):
        ...
        if (not re.search ('Configuration', options)):
            foremost_command = "foremost -d -o " + "'" + folder_path + "/" + filename_to_process + \
                               "/unallocated_files" + "'" + " -t " + str (
                options) + " -i " + Image_Path

        else:
            foremost_command = "foremost -d -o " + "'" + folder_path + "/" + filename_to_process + \
                               "/unallocated_files" + "'" + " -c /etc/foremost.conf -i " + Image_Path
        ...
        for key, value in partition_info_dict.items ():
            ...
            #set up foremost command
            if (not re.search ('Configuration', options)):
                foremost_command = "foremost -d -o " + "'" + folder_path + "/Partition_" + str (
                    key) + "/unallocated_files" + "'" + " -t " + str (options)
            else:
                foremost_command = "foremost -d -o " + "'" + folder_path + "/Partition_" + str (
                    key) + "/unallocated_files" + "'" + " -c /etc/foremost.conf"
            print ("The foremost_command is: " + foremost_command + "\n")
