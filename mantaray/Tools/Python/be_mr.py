...
def process_folder(evidence, folder_path_be, whitelist_location, speed, outfile, keyword_list, cores_to_use):
    ...
    if(whitelist_location != "NONE") and (keyword_list == "NONE"):
        be_command = "bulk_extractor -o " + folder_path_be + " -w " + whitelist_location + " -C 60 -j " + str(cores_to_use) + " -R " + evidence
    elif(whitelist_location == "NONE") and (keyword_list =="NONE"):
        be_command = "bulk_extractor -o " + folder_path_be + " -j " + str(cores_to_use) + " -C 60 -R " + evidence
    elif(whitelist_location != "NONE") and (keyword_list != "NONE"):
        be_command = "bulk_extractor -o " + folder_path_be + " -w " + whitelist_location + " -C 60 -F " + keyword_list + " -j " + str(cores_to_use) + " -R " + evidence
    elif(whitelist_location == "NONE") and (keyword_list != "NONE"):
        be_command = "bulk_extractor -o " + folder_path_be + " -x find -F " + keyword_list + " -C 60 -j " + str(cores_to_use) + " -R " + evidence
...
def be_mr(item_to_process, case_number, folder_path, evidence, whitelist_location, speed, keyword_list):
    ...
    if(item_to_process == "Directory"):
        ...
        if(whitelist_location != "NONE") and (keyword_list == "NONE"):
            be_command = "bulk_extractor -o " + folder_path_be + " -C 60 -w " + whitelist_location + " -j " + str(cores_to_use) + " " + evidence
        elif(whitelist_location == "NONE") and (keyword_list =="NONE"):
            be_command = "bulk_extractor -o " + folder_path_be + " -C 60 -j " + str(cores_to_use) + " " + evidence
        elif(whitelist_location != "NONE") and (keyword_list != "NONE"):
            be_command = "bulk_extractor -o " + folder_path_be + " -C 60 -w " + whitelist_location + " -F " + keyword_list + " -j " + str(cores_to_use) + " " + evidence
        elif(whitelist_location == "NONE") and (keyword_list != "NONE"):
            be_command = "bulk_extractor -o " + folder_path_be + " -C 60 -F " + keyword_list + " -j " + str(cores_to_use) + " " + evidence
