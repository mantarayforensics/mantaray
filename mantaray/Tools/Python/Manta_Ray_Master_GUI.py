...
import sys
from share.Tools.Python.be_mr import *
from share.Tools.Python.jumplist_mr import *
from share.Tools.Python.entropy_mr import *
from share.Tools.Python.extract_registry_hives_mr import *
from share.Tools.Python.mr_registry import *
from share.Tools.Python.GUI_Timeline_mr import *
from share.Tools.Python.remove_duplicates_mr import *
from share.Tools.Python.carve_unallocated_mr import *
from share.Tools.Python.volatility_mr import *
from share.Tools.Python.exifdata_mr import *
from share.Tools.Python.extract_ntfs_artifacts_mr import *
from share.Tools.Python.create_kml_from_exif_mr import *
from share.Tools.Python.plist_processor import *
from share.Tools.Python.filename_search_mr import *

### SPLASHSCREEN ###########################################################################

def splashscreen():

	intro_splashscreen = buttonbox(msg='', image='/usr/share/mantaray/images/Mantaray_Logo_Template_Full_Screen.gif',title='MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com', choices=('Continue', 'About', 'License', 'Support', 'System Requirements', 'Exit'))

	if intro_splashscreen == "About":
	
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/about.txt --title "MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com" --width 800 --height 625'], shell=True, universal_newlines=True)
	...
	if intro_splashscreen == "License":	
		...
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/MR_GNU_License.txt --title "MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com" --width 800 --height 400'], shell=True, universal_newlines=True)
	...
	if intro_splashscreen == "Support":
		...
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/support.txt --title "MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com" --width 800 --height 400'], shell=True, universal_newlines=True)
	...
	if intro_splashscreen == "System Requirements":
		...
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/sys_requirements.txt --title "MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com" --width 800 --height 400'], shell=True, universal_newlines=True)
	...
	if x == 'BulkExtractor':
		...
		if(super_timeline_options == "Plaso"):
			...
			try:		
				...
				plaso_processor = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System		MantaRayForensics.com" --column="Selection" --column="Processor Performance" --column="Description" --separator="," FALSE "Speed-Slow" "Minimum Processing Cores" TRUE "Speed-Med" "Medium Processing Cores (Recommended)" FALSE "Speed-Fast" "Maximum Processing Cores (Warning - Processor Intensive)" --text="Processing Performance - Plaso" --width 800 --height 400'], shell=True, universal_newlines=True)
