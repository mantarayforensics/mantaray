    ...
    for root, dirs, files in os.walk (mount_point):
        for filenames in files:
            ...
            if (fileExtension.lower () == ".jpg") or (fileExtension.lower () == ".jpeg"):
                exiftool_command = "exiftool -ext " + fileExtension.lower () + " " + quoted_full_path + " | grep 'GPS " \
                                                                                                        "Position'"
                ...
                if (result):
                    ...
                    if (os.path.isfile (folder_path + "/Processed_files_" + str (
                            key) + "/GPS_DATA/" + "GPS_EXIF_data.kml")):
                    ...
                    shutil.copyfile (full_path,
                                     folder_path + "/Processed_files_" + str (key) + "/GPS_DATA/" + filenames)
                    ...
                    md5value = subprocess.check_output (["md5sum " + quoted_full_path + "| awk '{print $1}'"],
...
process_choice = buttonbox (msg='What would you like to scan?', title='AV Scanning',
                            choices=('Folder', 'Entire Disk Image'), image=None, root=None)
...
if (process_choice == "Folder"):
    ...
    for key, value in sorted (partition_info_dict.items ()):
        ...
        #disable auto-mount in nautilis - this stops a nautilis window from popping up everytime the mount command is
        #  executed
        ...
        #call mount sub-routine
        print ("Unmounting mount point before exiting", end="\n\n")
