    ...
    def process_fi (self, fi):
        ...
        for run in fi.byte_runs ():
            try:
                ...
                if args.mactimes:
                    fileinfo = (
                    fname, md5val, gval (fi.crtime ()), gval (fi.ctime ()), gval (fi.mtime ()), gval (fi.atime ()))
                else:
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser (prog='identify_filenames.py',
    ...
    if args.xmlfile:
        ...
        if generator_program == "BULK_EXTRACTOR":
            raise RuntimeError (
                "\nERROR: {} was generated by BULK_EXTRACTOR.\nYou must provide a DFXML file that was generated by "
                "fiwalk\n".format (
                    args.xmlfile))
    ...
    for feature_file in feature_file_list:
        ...
        (feature_count, located_count) = process_featurefile2 (rundb, report.open (feature_file, mode='rb'),
                                                               open (output_fn, "wb"))
