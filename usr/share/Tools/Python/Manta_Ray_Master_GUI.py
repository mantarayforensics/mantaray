...
def splashscreen():
	...
	intro_splashscreen = buttonbox(msg='', image='/usr/share/mantaray/images/Mantaray_Logo_Template_Full_Screen.gif',title='MantaRay - ManTech Triage & Analysis System	v1.3.9	MantaRayForensics.com', choices=('Continue', 'About', 'Update', 'License', 'Support', 'System Requirements', 'Exit'))

	if intro_splashscreen == "About":
	
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/about.txt --title "MantaRay - ManTech Triage & Analysis System	   v1.3.9	MantaRayForensics.com" --width 800 --height 625'], shell=True, universal_newlines=True)
	...
	if intro_splashscreen == "License":	
		...
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/MR_GNU_License.txt --title "MantaRay - ManTech Triage & Analysis System    v 1.3.9	MantaRayForensics.com" --width 800 --height 400'], shell=True, universal_newlines=True)
	...
	if intro_splashscreen == "Support":
		...
		try:
			subprocess.call(['zenity --text-info --filename=/usr/share/mantaray/Tools/Python/support.txt --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --width 800 --height 400'], shell=True, universal_newlines=True)
...
if fieldValues: 
	...
	try:
		evidence_type = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Evidence Type" --column="Description" --separator="," TRUE "Bit-Stream Image" ".dd, .img, .001, .E01" FALSE "Directory" "Logical Directory" FALSE "EnCase Logical Evidence File" ".L01" FALSE "Memory Image" "Forensic Image of RAM" FALSE "Single File" "Individual File" --text="Evidence Type Selection" --width 800 --height 400'], shell=True, universal_newlines=True)
...
try:
	...
	debug_mode = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Debug Option" --column="Description" --column="Warning" --separator="," TRUE "OFF" "Default mode, no verbose error logging" "" FALSE "ON" "Debugging mode, verbose error logging" "All processes will stop at first error" --text="Debugging Option Selection" --width 800 --height 175'], shell=True, universal_newlines=True)
...
for x in processing_scripts_list:
	...
	if x == 'BulkExtractor':
		...
		try:
			...
			bulkextractor_options = subprocess.check_output(['zenity --list --checklist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processing Option" --column="Description" --separator="," FALSE "Keyword List" "Search for case specific keyword list" FALSE "Whitelist" "Remove known features (artifacts) from process output" --text="Processing Options - BulkExtractor" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		try:		
			...
			bulkextractor_processor = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processor Performance" --column="Description" --separator="," FALSE "Speed-Slow" "Minimum Processing Cores" TRUE "Speed-Med" "Medium Processing Cores (Recommended)" FALSE "Speed-Fast" "Maximum Processing Cores (Warning - Processor Intensive)" --text="Processing Performance - BulkExtractor" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		try:
			...
			foremost_options = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processing Option" --column="Description" --separator="," TRUE "Default File Signatures" "jpg,gif,png,bmp,avi,exe,mpg,wav,riff,wmv,mov,pdf,ole,doc,zip,rar,htm,cpp" FALSE "Configuration File" "Use configuration file - (/etc/foremost.conf)" --text="Processing Options - Foremost" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		try:
			super_timeline_options = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processing Option" --column="Tool Version" --column="Description" --separator="," FALSE "Log2Timeline" "v. 0.65" "Original timeline tool, outputs mactime, bodyfile, and csv format" FALSE "Plaso" "v. 1.1" "Updated timeline tool, outputs a .dmp file for further processing into a csv, raw, or dynamic output." --text="Select Timeline Tool" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		if(super_timeline_options == "Plaso"):
			...
			try:		
				...
				plaso_processor = subprocess.check_output(['zenity --list --radiolist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processor Performance" --column="Description" --separator="," FALSE "Speed-Slow" "Minimum Processing Cores" TRUE "Speed-Med" "Medium Processing Cores (Recommended)" FALSE "Speed-Fast" "Maximum Processing Cores (Warning - Processor Intensive)" --text="Processing Performance - Plaso" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		try:
			...
			registry_extractor_options = subprocess.check_output(['zenity --list --checklist --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --column="Selection" --column="Processing Option" --column="Description" --separator="," FALSE "Overt,Deleted,Restore-Points" "Overt/Deleted/Restore-Points(WinXP) Registry Hives" FALSE "Unallocated" "Unallocated Registry Hives (regf Header - 50MB Length)" FALSE "Shadow Volumes" "Shadow Volume Registry Hives (Windows Vista/7)" --text="Processing Options - Registry Extractor" --width 800 --height 400'], shell=True, universal_newlines=True)
		...
		try:
			select_profile = subprocess.check_output(['zenity --question --title "MantaRay - ManTech Triage & Analysis System    v.1.3.9	MantaRayForensics.com" --text="If the OS profile is known, select yes and then enter it on the following prompt. Otherwise select no and the imageinfo scan will provide suggestions for the source image." --width 800 --height 200'], shell=True, universal_newlines=True)
