...
def remove_dupes_module (folder, outfile):
    ...
    answer = boolbox (msg='Do you want to make a backup copy of your folder before removing the dupes?', title=' ',
    ...
    if (answer == 1):
        ...
        msgbox (msg='(Your folder has been copied to /tmp)', title='Copy Complete ', ok_button='OK', image=None,
                root=None)
